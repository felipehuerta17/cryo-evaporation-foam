...
Transfinite Line{6} = n_r Using Bump 0.25;
Transfinite Line{8} = n_r Using Bump 0.25;

Transfinite Line{7} = n_z Using Bump 0.25;
Transfinite Line{5} = n_z Using Bump 0.25;
